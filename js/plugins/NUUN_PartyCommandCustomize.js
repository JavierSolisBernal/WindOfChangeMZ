 ...
 *
 * Behavior varies depending on where you place this plugin.
 * Placing it at the bottom allows you to set the display order for all commands. If you are adding commands from other plugins, enter the corresponding string in "Commandkey".
 * If you are adding commands from other plugins without configuring them with this plugin, place it above those plugins.
 *
 * Specifications
 * Party commands will be omitted if there are one or fewer items in the party command list.
 *
 * Update History
 * 更新履歴
 * 2022/2/26 Ver.1.0.0
