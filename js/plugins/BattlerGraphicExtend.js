 ...
 * Expands the representation of battler images during battle.
 * A variety of effects are possible, such as floating in the air, changing color tone and size.
 *
 ...
 * <BGE Altitude: n> n: Altitude (pixels)
 * Example: <BGE Altitude: 32>
 *
 * Sets the opacity of the battler.
 * Changes are also reflected in the state icon.
 * <BGE Opacity: n> n: Opacity (0..256)
 * Example: <BGE Opacity: 128>
 *
 * Sets the color tone of the battler. Specify each element numerically.
 * Changes are also reflected in the state icon.
 * <BGE Color Tone: r, g, b, g> r: Red, g: Green, b: Blue (-255..255), g: Gray (0..255)
 * Example: <BGE Color Tone: 255, 255, 255, 128>
 *
 * Makes the butler blink slowly. Specify each element numerically.
 * This process is somewhat heavy, so please be careful when running on mobile devices.
 * <BGE Flash: r, g, b, a> r: Red, g: Green, b: Blue, a: Intensity (0..255)
 * Example: <BGE Flash: 255, 0, 0, 128>
 *
 * To change the flash interval (a smaller value means faster blinking; the default is 15).
 * <BGE Flash Interval: f> f: Number of frames
 * Example: <BGE Flash Interval: 30>
 *
 * Sets the butler compositing method.
 * <BGE Blending Method: n> n:0 [Normal] n:1 [Add] n:2 [Multiply] n:3 [Screen]
 * Example: <BGE Blending Method: 2>
 *
 * Sets the scale factor of the battler. A value of -100 will invert the image.
 * <BGE Scale Factor X: n> n: Scale factor (100%)
 * <BGE Scale Factor Y: n> n: Scale factor (100%)
 * Example: <BGE Scale Factor Y: 150>
 *
 * Sets the motion speed of the battler.
 * This setting is only valid for actors.
 * <BGE Motion Scale Factor: n> n: Scale factor (100%)
 * Example: <BGE Motion Scale Factor: 150>
 *
